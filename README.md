...
[DEAUTH] 00:11:22:33:44:66 reason=3
...
| Metric | Target | Where |
|---|---|---|
| Firmware compile | `arduino-cli compile --fqbn esp32:esp32:esp32 firmware/h1_deauth_oled` PASS | CI/local |
| Host helper | `python3 host/h1_cli.py --demo` exits 0 (offline) | host/ |
